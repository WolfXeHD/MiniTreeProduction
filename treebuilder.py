...
hax.init(experiment='XENON1T',
         ...
         minitree_paths = ['.', '/dali/lgrandi/xenon1t/minitrees/pax_v' + pax_version, '/project2/lgrandi/xenon1t/minitrees/pax_v'+pax_version, '/project/lgrandi/xenon1t/minitrees/pax_v' + pax_version],
         make_minitrees = True,
         tqdm_on = False
)
